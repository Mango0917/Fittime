<?php
    ...
    if($firstname&&$lastname&&$email&&$age&&$gender&&$password&&$activity&&$dietary_pref){
        ...
        if(mysqli_num_rows($search_result)>0){
            ...
            $query="INSERT INTO users VALUES('','$email','$password','$firstname','$lastname','$gender','$age','165','65','$dietary_pref','no','$activity','0','$dd','$mm','$yyyy')";
